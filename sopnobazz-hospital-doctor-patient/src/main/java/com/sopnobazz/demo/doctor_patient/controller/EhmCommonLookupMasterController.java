...
import com.sopnobazz.demo.doctor_patient.service.EhmCommonLookupMasterService;
...
@AllArgsConstructor
@RestController
@RequestMapping(EHM_END_POINT+"common-lookup-master")
public class EhmCommonLookupMasterController {

    private final EhmCommonLookupMasterService service;
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody EhmCommonLookupMaster body, HttpServletRequest request){
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody EhmCommonLookupMaster body, HttpServletRequest request){
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody EhmCommonLookupMaster body){
        try {
