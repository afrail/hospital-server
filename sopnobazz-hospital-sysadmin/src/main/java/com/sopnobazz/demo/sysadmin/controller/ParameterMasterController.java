...
import com.sopnobazz.demo.sysadmin.service.ParameterMasterService;
...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "parameter-master")
public class ParameterMasterController implements MessageConstants {
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody ParameterMaster body, HttpServletRequest request) {
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody ParameterMaster body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody ParameterMaster body) {
        try {
