...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "app-user")
public class AppUserController implements MessageConstants {
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody AppUser body, HttpServletRequest request) {
        try {
...
//			e.printStackTrace();
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody AppUser body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody AppUser body) {
        try {
    ...
    @GetMapping("/profile")
    public CommonResponse getProfile(HttpServletRequest request) throws Exception {
        try {
            return commonUtils.generateSuccessResponse(service.getProfile(authTokenUtils.getUserIdFromRequest(request)));
        } catch (Exception e) {
            return commonUtils.generateErrorResponse(e);
        }
    ...
    public CommonResponse changePassword(@RequestBody PasswordChangeDto dto, HttpServletRequest request) throws Exception {
        try {
            return commonUtils.generateSuccessResponse(service.changePassword(dto, authTokenUtils.getUserIdFromRequest(request)));
        } catch (Exception e) {
            e.printStackTrace();
            return commonUtils.generateErrorResponse(e);
        }
