...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "user-role-assign")
public class UserRoleAssignController implements MessageConstants {
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody UserRoleAssignDto body, HttpServletRequest request) {
        try {
            body.getMaster().setEntryUser(authTokenUtils.getUserIdFromRequest(request));
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody UserRoleAssignDto body, HttpServletRequest request) {
        try {
            body.getMaster().setUpdateUser(authTokenUtils.getUserIdFromRequest(request));
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody UserRoleAssignDto body) {
        try {
