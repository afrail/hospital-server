...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "report-with-parameter")
public class ReportWithParameterController implements MessageConstants {

    @SuppressWarnings("unused")
    private static final Logger LOG = LoggerFactory.getLogger(ReportWithParameterController.class);

    private final ReportWithParameterService service;
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody ReportWithParameter body, HttpServletRequest request) {
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody ReportWithParameter body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody ReportWithParameter body) {
        try {
