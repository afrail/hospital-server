...
import com.sopnobazz.demo.sysadmin.service.MenuItemService;
...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "menu-item")
public class MenuItemController implements MessageConstants {
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody MenuItem body, HttpServletRequest request) {
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody MenuItem body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody MenuItem body) {
        try {
    ...
    @GetMapping(value = "get-by-type/{typeId}")
    public CommonResponse getByMenuType(@PathVariable("typeId") int typeId) {
        try {
            return commonUtils.generateSuccessResponse(service.getByMenuType(typeId));
        } catch (Exception e) {
            return commonUtils.generateErrorResponse(e);
        }
    }

    @GetMapping(value = "get-by-type-not/{typeId}")
    public CommonResponse getByMenuTypeNot(@PathVariable("typeId") int typeId) {
        try {
            return commonUtils.generateSuccessResponse(service.getByMenuTypeNot(typeId));
        } catch (Exception e) {
            return commonUtils.generateErrorResponse(e);
        }
    }
