...
import com.sopnobazz.demo.comon.service.PasswordPolicyService;
...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "password-policy")
public class PasswordPolicyController implements MessageConstants {
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody PasswordPolicy body, HttpServletRequest request) {
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody PasswordPolicy body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody PasswordPolicy body) {
        try {
