...
import com.sopnobazz.demo.sysadmin.service.MenuItemUrlService;
...
@AllArgsConstructor
@RestController
@RequestMapping(ApiConstants.SYSTEM_ADMIN_END_POINT + "menu-item-url")
public class MenuItemUrlController implements MessageConstants {

    @SuppressWarnings("unused")
    private static final Logger LOG = LoggerFactory.getLogger(MenuItemUrlController.class);

    private final MenuItemUrlService service;
    ...
    @PostMapping
    public CommonResponse save(@Valid @RequestBody MenuItemUrl body, HttpServletRequest request) {
        try {
    ...
    @PutMapping
    public CommonResponse update(@Valid @RequestBody MenuItemUrl body, HttpServletRequest request) {
        try {
    ...
    @DeleteMapping
    public CommonResponse delete(@Valid @RequestBody MenuItemUrl body) {
        try {
