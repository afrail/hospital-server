...
import com.sopnobazz.demo.comon.base.constants.Constants;
...
public class ServiceExceptionHolder {
    ...
    public static class BadRequestException extends ServiceException {
        ...
        public static String getErrorMessage(Exception e) {
            ...
            if (msgType.equals("uk") || msgType.equals("re")) return Constants.DATA_ALRADY_EXISTS_MESSAGE;
            else if (msgType.equals("fk")) return Constants.CHILD_RECORD_FOUND;
            else {
                String[] subString = getNotNullMessage(e.getMessage());
                if (null == subString) return e.getMessage();
                if (subString.length > 0) {
                    if (subString[1].equals("of relation")) return subString[0] + " can't be null";
                    else return "Internal System Error";
                } else return "Internal System Error";
            }
        }
